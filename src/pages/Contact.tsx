  ...
  return (
    <div className="max-w-6xl mx-auto py-12 space-y-24">
      ...
      <section className="space-y-8">
        ...
        <h1 className="font-brutal text-6xl md:text-9xl font-black tracking-tighter leading-[0.8] uppercase">
          STK_<span className="text-primary bg-black px-4 -ml-4 inline-block transform -skew-x-12">CONTACT</span>
        </h1>
        <p className="font-display text-2xl text-on-surface-variant leading-tight max-w-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-7">
          <div className="bg-black p-12 border-2 border-primary relative overflow-hidden group rounded-none shadow-[8px_8px_0px_0px_rgba(0,229,255,1)]">
            <div className="mb-12">
              <div className="flex items-center gap-4 mb-4">
                <Share2 className="w-8 h-8 text-primary" />
                <h2 className="font-brutal text-4xl font-black tracking-tighter uppercase">NEURAL_CONNECT</h2>
              </div>
            ...
            <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="w-full bg-primary py-6 rounded-none font-mono text-base font-black tracking-[0.3em] text-black hover:bg-white transition-all flex justify-center items-center gap-4 group uppercase border-2 border-primary">
        ...
        <div className="lg:col-span-5 space-y-12">
          <div className="bg-black p-12 border-2 border-primary rounded-none">
            ...
            <div className="grid grid-cols-2 gap-8">
              {[
                ...
                { name: 'MEDIUM', icon: Edit3, url: '#' },
                { name: 'EMAIL', icon: Mail, url: 'mailto:karthiksurya611@gmail.com' },
              ].map(node => (
                <a 
                  key={node.name} 
                  href={node.url} 
                  className="flex flex-col items-center gap-6 p-8 rounded-none bg-black border-2 border-primary/20 hover:border-primary hover:bg-primary transition-all group"
                >
                  <div className="w-16 h-16 flex items-center justify-center rounded-none bg-primary/10 group-hover:bg-black transition-all">
                    <node.icon className="w-8 h-8 text-primary group-hover:text-primary" />
                  </div>
                  <span className="font-mono text-[10px] font-black tracking-[0.2em] text-primary/40 group-hover:text-black transition-colors">{node.name}</span>
                </a>
              ))}
            </div>
          </div>
