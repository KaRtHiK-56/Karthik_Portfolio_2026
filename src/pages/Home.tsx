    ...
    <div className="space-y-32">
      ...
      <section className="min-h-[80vh] flex flex-col justify-center relative">
        <motion.div 
          ...
          className="mb-6 flex items-center gap-4 px-4 py-2 w-fit bg-surface-container-low rounded-lg border border-white/5"
        >
          <span className="flex h-2 w-2 rounded-full bg-primary-container animate-pulse"></span>
          <span className="font-mono text-[10px] tracking-widest text-primary uppercase">STATUS_ACTIVE // CORE_SYSTEM_ONLINE</span>
        </motion.div>
      ...
      <section className="py-24">
        <div className="mb-16">
          <h2 className="font-brutal text-4xl font-bold mb-4">CORE_CAPABILITIES</h2>
          <div className="h-px w-24 bg-gradient-to-r from-primary-container to-transparent"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <motion.div
              ...
              className="group p-8 bg-surface-container-high rounded-xl border border-white/5 hover:border-primary-container/30 transition-all duration-500 flex flex-col gap-6"
            >
              <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-surface-container-highest text-primary">
              ...
              <div className="mt-auto font-mono text-[10px] text-primary/50 group-hover:text-primary transition-colors">
                {cap.tag}
              </div>
            </motion.div>
          ))}
    ...
    <li key={index}>{point}</li>
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {project.tags.map(tag => (
                    <span key={tag} className="px-4 py-1.5 rounded-full border border-primary-container/30 text-[10px] font-mono text-primary-container tracking-wider">
                      {tag}
                    </span>
                  ))}
                </div>
                ...
                <Link 
                  to="/projects" 
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-container to-secondary-container text-on-primary font-mono text-xs font-bold rounded-full w-fit hover:scale-105 transition-all shadow-lg shadow-primary-container/20"
                >
            ...
            <div className="grid grid-cols-4 gap-4">
              {[
                ...
                <a key={node.name} href="#" className="flex flex-col items-center gap-3 group">
                  ...
                  <span className="font-mono text-[9px] text-slate-500 group-hover:text-primary transition-colors">{node.name}</span>
                </a>
              ))}
            </div>
          </div>

          <div className="relative h-48 rounded-2xl overflow-hidden grayscale hover:grayscale-0 transition-all duration-700">
            <img 
