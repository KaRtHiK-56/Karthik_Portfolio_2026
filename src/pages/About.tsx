...
import profilePic from '../profile_karthik.png';
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 md:px-12 py-12 space-y-24">
      ...
      <section className="space-y-8">
        ...
        >
          About<br/>
          <span className="text-primary bg-surface-container-highest px-4 -ml-4 inline-block transform -skew-x-12 ai-glow-primary">KARTHIK</span>
        </motion.h1>
      ...
      {/* Bio */}
      <section className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start relative">
        ...
        <div className="md:col-span-8 space-y-12 relative z-10">
          <div className="space-y-4">
            <h3 className="font-mono text-xl font-black text-primary uppercase tracking-widest border-b-2 border-primary/20 pb-2 flex items-center gap-4">
      ...
      {/* Key Strengths */}
      <section className="space-y-12 relative overflow-hidden p-12 bg-surface-container border-2 border-primary">
        <div className="absolute inset-0 ai-data-stream opacity-5 pointer-events-none"></div>
        <div className="text-center relative z-10">
          <h2 className="font-brutal text-3xl font-black uppercase tracking-tighter">SYSTEM_ANALYSIS</h2>
          <p className="font-mono text-[10px] text-primary/40 mt-2 tracking-[0.5em] uppercase font-black">CORE_COMPETENCIES_MAPPED</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 relative z-10">
          {[
            ...
            <motion.div
              ...
              className="p-8 bg-surface-container-low border-2 border-primary/20 flex flex-col items-center text-center gap-4 group hover:border-primary hover:bg-primary transition-all rounded-none relative"
            >
              <div className="text-4xl mb-2 group-hover:scale-125 transition-transform relative z-10">{strength.emoji}</div>
              <div className="ai-neural-node w-12 h-12">
                <strength.icon className="w-8 h-8 text-primary group-hover:text-on-primary transition-colors relative z-10" />
              </div>
              <h4 className="font-mono text-[10px] font-black tracking-[0.3em] uppercase group-hover:text-on-primary relative z-10">{strength.title}</h4>
            </motion.div>
          ))}
        </div>
      </section>
